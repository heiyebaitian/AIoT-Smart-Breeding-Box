...
uint16_t Serial_RxPacket[4];				//定义接收数据包数组，FF,FE，水泵，风扇， 生长灯
uint8_t Serial_RxFlag;					//定义接收数据包标志位
uint8_t Serial_RxPacket_Water[3];				//水泵开关
uint8_t Serial_RxPacket_Fan[3];				//风扇开关
uint8_t Serial_RxPacket_Light[3];				//灯开关
/**
  * 函    数：串口初始化
  * 参    数：无
  * 返 回 值：无
